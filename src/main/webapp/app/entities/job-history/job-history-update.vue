  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="testApp.jobHistory.home.createOrEditLabel"
          data-cy="JobHistoryCreateUpdateHeading"
          v-text="t$('testApp.jobHistory.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testApp.jobHistory.startDate')" for="job-history-startDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testApp.jobHistory.endDate')" for="job-history-endDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testApp.jobHistory.language')" for="job-history-language"></label>
            <select
              class="form-control"
              name="language"
            ...
            >
              <option
                ...
                v-bind:label="t$('testApp.Language.' + language)"
              >
                {{ language }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testApp.jobHistory.job')" for="job-history-job"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testApp.jobHistory.department')" for="job-history-department"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testApp.jobHistory.employee')" for="job-history-employee"></label>
